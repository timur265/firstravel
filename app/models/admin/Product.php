...
class Product extends AppModel {
    ...
    public function getEditImg($img){
    ...
    public function getEditImg2($img2){
        if(!empty($_SESSION['single_inside'])){
            $this->attributes['img2'] = $_SESSION['single_inside'];
        }else{
            $this->attributes['img2'] = $img2;
        }
        unset($_SESSION['single_inside']);
    }
    ...
    public function saveProgramContent($id, $sub_title, $sub_content) {
        \R::exec("INSERT INTO tour_program_content(product_id, sub_title, sub_content) 
                        VALUES ($id, '$sub_title', '$sub_content')");
    }

    public function savePrice($id, $title_price, $single_price) {
        \R::exec("INSERT INTO price (product_id, single_price, title_price) 
                        VALUES($id, $single_price, '$title_price')");
    }
    ...
    public function uploadImg($name, $wmax, $hmax){
        ...
        if(@move_uploaded_file($_FILES[$name]['tmp_name'], $uploadfile)){
            if($name == 'single'){
                ...
                $_SESSION['single_inside'] = $new_name;
            }
